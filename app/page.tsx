...
function NavGlyph({id}:{id:Tab}){if(id==='id')return <svg viewBox="0 0 32 32" aria-hidden="true"><rect className="nav-document-body" x="7" y="2" width="18" height="28" rx="1.8"/><path className="nav-document-lines" d="M10 19.5h12M10 24h12"/></svg>;if(id==='services')return <svg viewBox="0 0 32 32" aria-hidden="true"><rect x="4" y="3" width="10" height="11" rx="1.5"/><rect x="18" y="3" width="10" height="11" rx="1.5"/><rect x="4" y="18" width="10" height="11" rx="1.5"/><rect x="18" y="18" width="10" height="11" rx="1.5"/></svg>;if(id==='jobs')return <svg viewBox="0 0 32 32" aria-hidden="true"><rect x="6" y="2.5" width="20" height="27" rx="1.8"/><rect className="nav-job-diamond" x="12" y="10" width="9" height="9" rx="1" transform="rotate(-40 16.5 14.5)"/></svg>;return <svg viewBox="0 0 32 32" aria-hidden="true"><path className="nav-menu-lines" d="M5 7h22M5 16h22M5 25h22"/></svg>}
